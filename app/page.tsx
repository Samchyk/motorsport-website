...
export default function Home() {
  const experiences = [
    {
      ...
      description:
        "Érezze meg a felhalmozódott energiát vezetéskor a leggyorsabb autók képes közvetítésére.",
      icon: "🏁",
    ...
    },
    {
      title: "Pályaképzés",
      description:
        "Szakmai oktatók vezetésével fejlessze versenyautózási készségeit a zárt pályán.",
      icon: "🎓",
    ...
    },
    {
      title: "Élmény csomag",
      description:
        "Kombinált szuperautó és oktatási élmények a legjobb motorsport kalandért.",
      icon: "⚡",
    ...
    },
    {
      title: "VIP programok",
      description:
        "Exkluzív, személyre szabott motorsport élmények a legigényesebb vendégek számára.",
      icon: "👑",
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto">
          <SectionReveal className="mb-16 text-center">
            ...
            <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
              Válassza ki az Ön számára tökéletes élményt és tapasztalja meg az
              adrenalin csúcsát.
            </p>
          </SectionReveal>
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-background/50 border-t border-white/10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <SectionReveal className="mb-16 text-center">
            ...
            <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
              A világon legújabb és leggyorsabb szuperautók közül választhat az
              Ön ideális élménye érdekében.
            </p>
          </SectionReveal>
            ...
            <SectionReveal direction="left">
              <div className="space-y-6">
                ...
                <p className="text-lg text-foreground/60">
                  A legmagasabb szintű biztonság, professzionális oktatók és
                  világszínvonalú szuperautók kombinációja.
                </p>
      ...
      <section
        id="contact"
        className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-background/50 border-t border-white/10"
      >
        <div className="max-w-4xl mx-auto">
          <SectionReveal className="text-center mb-12">
            ...
            <p className="text-lg text-foreground/60">
              Személyre szabott ajánlatot kaphat az Ön ideális motorsport
              élményéhez.
            </p>
          </SectionReveal>
          <ContactForm />
